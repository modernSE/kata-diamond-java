...
public class DiamondTest {
	...
	public void diamond3_shouldPrint() {
		...
		String actual = new Diamond().build(3);
	...
	public void diamond5_shouldPrint() {
		...
		String actual = new Diamond().build(5);
		assertEquals(expected.toString(), actual);
		System.out.println(actual);
	}
	...
	public void diamond0_shouldReturnNull() {
		assertEquals(null, new Diamond().build(0));
	}

	@Test
	public void diamondNegative_shouldReturnNull() {
		assertEquals(null, new Diamond().build(-1));
	}

	@Test
	public void diamondEven_shouldReturnNull() {
		assertEquals(null, new Diamond().build(10));
	}
}
